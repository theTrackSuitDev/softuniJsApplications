...
// catchesFieldset.textContent = "Click to load cathes";
...
async function loadCatches() {
    ...
    try {
        ...
        if (homeSection.querySelector("#main")) {
            homeSection.querySelector("#main").remove();
        }

        let fieldset = document.createElement("fieldset");
        instruction.remove();
        homeSection.insertBefore(fieldset, document.querySelector("aside"));
        fieldset.id = "main";
        ...
        data.forEach((element) => {
            ...
            // Add escape function to prevent XSS attacks!!!
